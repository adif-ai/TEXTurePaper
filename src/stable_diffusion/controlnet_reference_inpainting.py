...
class StableDiffusionControlNetReferenceInpaintPipeline(
    StableDiffusionControlNetInpaintPipeline, StableDiffusionControlNetReferencePipeline
):
    def __init__(
        self,
        vae: AutoencoderKL,
        ...
        # StableDiffusionControlNetInpaintPipeline.__init__(vae, text_encoder, tokenizer, unet, controlnet, scheduler, safety_checker, feature_extractor, requires_safety_checker)
        # StableDiffusionControlNetReferencePipeline.__init__(vae, text_encoder, tokenizer, unet, controlnet, scheduler, safety_checker, feature_extractor, requires_safety_checker)
